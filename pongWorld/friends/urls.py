...
urlpatterns = [
    ...
    path('search/', views.SearchFriendsView.as_view({'get': 'get_all_friends'}), name="get_all_friends"),
    path('search/<str:name>/', views.SearchFriendsView.as_view({'get': 'get_friends'}), name="get_friends"),
]